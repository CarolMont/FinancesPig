...
import logoPig from "../../assets/estacio/logo-black.png";
...
export default function LoginScreen({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput value={email} onChangeText={(e) => setEmail(e)} placeholder=" seu email" style={styles.input}></TextInput>
            <TextInput value={password} onChangeText={(e) => setPassword(e)} secureTextEntry={true} placeholder="Sua senha" style={styles.input}></TextInput>
